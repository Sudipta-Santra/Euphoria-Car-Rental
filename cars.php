...
<body class="bg-info-subtle">
    ...
    <!-- Navbar -->
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
         ...
         <ul class="navbar-nav">
          <li class="nav-item fst-normal fw-semibold fs-5"><a class="nav-link" href="index.php">Home</a></li>
          <li class="nav-item fst-normal fw-semibold fs-5"><a class="nav-link active" href="cars.php">Cars</a></li>
